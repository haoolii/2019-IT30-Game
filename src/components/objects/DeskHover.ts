...
export default class DeskHover extends Sprite {
  ...
  private drawPlayerpair(graph: PIXI.Graphics, xoff: number, yoff: number) {
    // 閒對子
    // graph.clear()
    graph.beginFill(0)
    graph.alpha = 0
  ...
  private drawPlayer(graph: PIXI.Graphics, xoff: number, yoff: number) {
    // 閒
    graph.beginFill(0)
    graph.alpha = 0
  ...
  private drawPlayerking(graph: PIXI.Graphics, xoff: number, yoff: number) {
    // 閒王
    graph.beginFill(0)
    graph.alpha = 0
  ...
  private drawTiepair(graph: PIXI.Graphics, xoff: number, yoff: number) {
    // 平對
    graph.beginFill(0)
    graph.alpha = 0
  ...
  private drawTie(graph: PIXI.Graphics, xoff: number, yoff: number) {
    // 平對
    graph.beginFill(0)
    graph.alpha = 0
  ...
  private drawBankerking(graph: PIXI.Graphics, xoff: number, yoff: number) {
    // 莊王
    graph.beginFill(0)
    graph.alpha = 0
  ...
  private drawBanker(graph: PIXI.Graphics, xoff: number, yoff: number) {
    // 莊
    graph.beginFill(0)
    graph.alpha = 0
  ...
  private drawBankerpair(graph: PIXI.Graphics, xoff: number, yoff: number) {
    // 莊對
    graph.beginFill(0)
    graph.alpha = 0
  ...
  public onClick(listener: any): void {
    this._hoveArea.on('click', listener)
    this._hoveArea.on('tap', listener)
  }
}
